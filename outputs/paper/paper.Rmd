...
author: 
  - Zihan Zhang
  - Another author
thanks: "Code and data are available at: https://github.com/zihanjasmine/paper2."
...
f1 <- read.csv("fig_1.csv")
ggplot(f1, aes(x = year, y=brate_all)) +
  geom_point() +
  geom_line() +
  labs(y="Births per 1,000 women age 15–44") +
  theme_minimal() +
